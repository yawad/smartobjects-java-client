...
abstract class MapperUtils {
    ...
    private static final String OWNER_INSTANCE_TYPE = "OWNER";
    ...
    private static final DateTimeFormatter dateTimeFormatter = new DateTimeFormatterBuilder().append(null,
    ...
    static <V, T> Map<V, T> readValuesAsMap(JsonParser parser, Class<V> keyType, Class<T> valueType)
        ...
        try {
            ...
            return (HashMap<V, T>) ObjectMapperConfig.genericObjectMapper.readValue(parser, stringMapTypew);
        }
        catch (Exception e) {
    ...
    private static void throwIllegalArgument(String name, String value, String type) {
